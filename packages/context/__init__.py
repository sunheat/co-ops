"""Application-layer construction of the four Context Engineering layers."""
...
class ContextBuilder:
    ...
    Retrieval is intentionally mocked for now. Callers can supply mock chunks
    to the constructor for a scenario, or rely on the representative default.
    """
